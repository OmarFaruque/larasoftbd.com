...
class SS_Admin {
	...
	public function load_css() {
		wp_enqueue_style ( 'wp-social-sharing', get_template_directory_uri(). '/inc_function/social-sharing/static/admin-styles.css' );
		wp_enqueue_media();
		wp_enqueue_script( 'wp-social-sharing', get_template_directory_uri(). '/inc_function/social-sharing/static/socialshareadmin.js', array(), SS_VERSION, true );
	}
