...
<div id="ss" class="wrap">
	<div class="ss-container">
		<div class="ss-column ss-primary">
			...
			<table class="form-table">
				...
				<tr valign="top">
					<th><label for="facebook_text"><?php _e('Facebook Share button icon class','wp-social-sharing');?></label></th>
					<td>
				...
				<tr valign="top">
					<th><label for="twitter_text"><?php _e('Twitter Share button icon class','wp-social-sharing');?></label></th>
					<td>
				...
				<tr valign="top">
					<th><label for="googleplus_text"><?php _e('Google plus share button icon class','wp-social-sharing');?></label></th>
					<td>
				...
				<tr valign="top">
					<th><label for="linkedin_text"><?php _e('Linkedin share button icon class','wp-social-sharing');?></label></th>
					<td>
				...
				<tr valign="top">
					<th><label for="pinterest_text"><?php _e('Pinterest share button icon class','wp-social-sharing');?></label></th>
					<td>
	...
	<div class="ss-column ss-secondary">
		...
		<div class="ss-box">
		<h3>Plugin Shortcode</h3>
		<p>You can also use following shortcode or can set automatic wrap</p>
		<p><b>Shortcode:</b><br>
