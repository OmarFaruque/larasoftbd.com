<?php
//define("FAG_PLUGIN_URL", get_stylesheet_directory_uri() . '/inc_function/widgets/flickr-album-gallery/'); 
add_shortcode( 'FAG', 'FlickerAlbumGalleryShortCode' );
function FlickerAlbumGalleryShortCode( $Id ) {

    ob_start();
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'fag-bootstrap-min-js', FAG_PLUGIN_URL . 'js/bootstrap.min.js', array('jquery'), false, true );
	wp_enqueue_script( 'fag-imagesloaded-pkgd-min-js', FAG_PLUGIN_URL . 'js/imagesloaded.pkgd.min.js', array('jquery'), false, true );
	wp_enqueue_script( 'fag-jquery-blueimp-gallery-min-js', FAG_PLUGIN_URL . 'js/jquery.blueimp-gallery.min.js', array('jquery'), false, true );
	wp_enqueue_script( 'fag-bootstrap-image-gallery-min-js', FAG_PLUGIN_URL . 'js/bootstrap-image-gallery.min.js', array('jquery'), false, true );
	wp_enqueue_script( 'fag-flickr-jquery-js', FAG_PLUGIN_URL . 'js/flickr-jquery.js', array('jquery'), false, true );
						...
						<div class="gallery<?php echo $ID; ?>">
							...
							<div class="row">
								<div class="col-xs-12 spinner-wrapper">
								 ...
								 <div class="flickr-feed clearfix"><ul class="gallery-container"></ul></div>
							</div>
						</div>
						<?php
					}// end of foreach
